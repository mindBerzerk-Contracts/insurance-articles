    ...
    x = setInterval(function () {
      if (document.querySelectorAll(".contdown_row").length == 1) {
        ...
        for (
          ...
          (document.getElementById("days" + [i]).innerText = Math.floor(
            distance / day
          )),
            (document.getElementById("hours" + [i]).innerText = Math.floor(
              (distance % day) / hour
            )),
            (document.getElementById("minutes" + [i]).innerText = Math.floor(
              (distance % hour) / minute
            )),
            (document.getElementById("seconds" + [i]).innerText = Math.floor(
              (distance % minute) / second
            ));
        }
      }
